...
import { setCourse, setEditCourse, setStep } from '../../../../store/reducers/courseReducer'
...
const CourseBuilderForm = () => {
  ...
  const onSubmit = async(data)=>{
    ...
    if(result){
      // console.log("bhai ne bola karne ka toh karne ka....", result)
  ...
  const goToNext = ()=>{
    if(course.courseContent.length === 0){
      toast.error("Please add atleast one section to your course")
      return
    }
    if(course.courseContent.some(section => section.subSection.lenght === 0)){
      toast.error("Please add atleast one subsection to each section")
      return
    }
    dispatch(setStep(3))
  }
